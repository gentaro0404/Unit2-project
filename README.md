...
**Design statement**
Design Statement, We are creating a Presentation for our client, daiichirom. To do this, we need specific statistical data. That data will include a system diagram, a 48-hour visual representation and model of humidity and temperature in ISAK's room and ISAK's remote indoor area, and a forecast for the next 12 hours. Health implications for humidity and temperature levels will also be presented. This will be accomplished with the software Python on the Raspberry Pi. The project will take approximately one month to produce and will be evaluated on the following six criteria
